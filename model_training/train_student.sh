...
$MARIAN_BINARIES/marian \
    ...
    --train-sets $data_dir/train.$srclang $teacher_data \
    --max-length 256 \
    --vocabs $data_dir/joint.model.spm $data_dir/joint.model.spm \
    --mini-batch-fit true --mini-batch-fit-step 5 --workspace $workspace --maxi-batch 1000 --mini-batch 1000 --mini-batch-warmup 4000 \
